...
{/if}
		...
		<tr>
			<td valign="top">
				{if $tdData->extend2|regex_replace:"/.*\|\|/":""|truncate:2:""=="89"}
				    {if $tdData->extend2|regex_replace:"/.*\|\|/":""|truncate:3:""=="899"}
                    <img border="1" src="http://image.aladdin.co.kr/cover/cover/{$tdData->extend2|regex_replace:"/.*\|\|/":""}_1.jpg" align="left" style="margin-right:5px"/>
                    {else}
                    <img border="1" src="http://image.aladdin.co.kr/cover/cover/{$tdData->extend2|regex_replace:"/.*\|\|/":""}_1.gif" align="left" style="margin-right:5px"/>
                    {/if}
				{else}
				<img border="1" src="http://images.amazon.com/images/P/{$tdData->extend2|regex_replace:"/.*\|\|/":""}.01.MZZZZZZZ.gif" align="left" style="margin-right:5px"/>
				{/if}
				{* 저자와 출판사는 같은 필드를 이용한다. 경계 문자는 ; *}
				<font color="#008100"><b>Category</b></font> : {$tdData->category_name}<br />
				<font color="#008100"><b>Author</b></font> : {$tdData->extend1|regex_replace:"/\|\|.*/":""}<br />
				{if $tdData->extend1|regex_replace:"/.*\|\|/":"" !=""}
				<font color="#008100"><b>Translator</b></font> : {$tdData->extend1|regex_replace:"/.*\|\|/":""}<br />
				{/if}
				<font color="#008100"><b>Publisher</b></font> : {$tdData->extend2|regex_replace:"/\|\|.*/":""}<br />
				<br/>
				{$tdData->note}
			</td>
		</tr>
		<tr>
			<td height="30" align="right" colspan="2" valign="bottom">
...
{/if}
	...
	{* 2단 구조 사용시 *}
	{cycle values="</td><td valign=\"top\" width=\"50%\">,</td></tr><tr><td valign=\"top\" width=\"50%\">"}
{/foreach}
	</td>
</tr>
</table>
