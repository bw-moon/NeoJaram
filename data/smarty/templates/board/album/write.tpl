...
<dd>
<textarea name="note" cols="40" id="note" class="input_box" rows="20" title="내용" required>{if $USING_REPLY !=""}
---------- ---------- ----------
...
<dd>
<iframe id="hiddenFrame" name="hiddenFrame" style="positoon:absolute;display:none;visibility:hidden;height:0px;weight:0px"></iframe>
...
<div id="boardTool">
<input type="button" id="btn_post_article" name="btn_post_article" onclick="javascript:doSubmitArticle()" value="글올리기"/> <input type="button" name="btn_post_cancel" onclick="javascript:history.back(-1);" value="취소">
</div>
</div>