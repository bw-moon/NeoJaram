 ...
 * Name:     wakka_wiki<br>
 * Date:     Mar 23, 2007
 * Purpose:  convert raw wakka wiki format text  to html
 * Input:<br>
 *         - contents = wakka wiki style raw data
 * Example:  {$raw_wiki_data|wakka_wiki}
 * @version  1.0
...
function smarty_modifier_wakka_wiki($text)
{
